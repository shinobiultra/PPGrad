...
TEST(MultTensorTest, GradientPropagationManual) {
    ...
    std::vector<std::shared_ptr<PPGrad::TensorBase<2, double>>> resultTensors = LSum(tensors);
    ...
    double resultNumerical = LSum(eigenTensors);
    ...
    for (int i = 0; i < N; i++) {
        ...
        // debug nicely print them out
        // std::cout << "grad: " << grad << std::endl;
        // std::cout << "numericalGrad: " << numericalGrad << std::endl;
